...
## Corpus Check
- 411 files · ~354,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2560 nodes · 6617 edges · 157 communities (131 shown, 26 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `142b52b3`
...
4. `validationError()` - 56 edges
5. `generateUuidV7()` - 55 edges
6. `formatMoney()` - 54 edges
7. `notFound()` - 51 edges
8. `cn()` - 50 edges
9. `buildAuditLogInsert()` - 50 edges
10. `createDb()` - 48 edges
...
Cohesion: 0.19
Nodes (12): StepBalances(), StepBalancesProps, StepPassword(), StepPasswordProps, Stepper(), StepperProps, StepRecipes(), StepRecipesProps (+4 more)

### Community 1 - "Inventory Command Services"
Cohesion: 0.18
Nodes (18): CountDetailView(), CountDetailViewProps, errorMessage(), ExitForm(), exitFormInitialState, StepCount(), StepCountProps, useCommitCount() (+10 more)

### Community 2 - "Auth Routes & Audit Log"
Cohesion: 0.18
Nodes (27): AuditEntry, buildAuditLogInsert(), listAuditLogForEntity(), addItemAlias(), removeItemAlias(), bulkCreateItems(), ItemRow, Statement (+19 more)

### Community 3 - "Onboarding & Catalog API"
Cohesion: 0.24
Nodes (9): ACTOR, catalogRoute, addItemAliasCommandSchema, createItemCommandSchema, listItemsFiltersSchema, mergeItemsCommandSchema, removeItemAliasCommandSchema, setItemActiveCommandSchema (+1 more)

### Community 4 - "Backups & Dashboard API"
Cohesion: 0.08
Nodes (34): BackupRunDetail, ADR-0015, ACTOR, ACTOR, CONTENT_TYPE_EXTENSIONS, purchasingRoute, isLoginRateLimited(), recordFailedLoginAttempt() (+26 more)

### Community 5 - "WAC Costing Engine"
Cohesion: 0.10
Nodes (37): computePurchaseLineUnitCost(), buildPurchaseCreateMovements(), buildPurchaseDeleteMutationInputs(), buildPurchaseInMovementsFromLines(), buildPurchaseTransactionInputs(), buildPurchaseUpdateMutationInputs(), commitPurchaseMutation(), compareKardexRows() (+29 more)

### Community 6 - "Stock Drift Repair & Counts API"
Cohesion: 0.07
Nodes (26): businessDateSchema, CollectPaymentCommand, collectPaymentCommandSchema, CollectPaymentResult, DeleteSaleCommand, deleteSaleCommandSchema, DeleteSaleResult, ListReceivablesResult (+18 more)

### Community 7 - "Financial Accounts & Transactions"
Cohesion: 0.12
Nodes (35): ACTOR, assertSafeIntegerInput(), assertValidTransactionAmount(), BalanceMismatchDto, BalanceMismatchRow, buildAccountBalanceDelta(), buildReplaceTransactionsForSourceStatements(), buildTransactionInsert() (+27 more)

### Community 8 - "Finance & Count Dialogs UI"
Cohesion: 0.09
Nodes (32): ExitFormProps, countsFiltersToQueryString(), exitsFiltersToQueryString(), INVENTORY_ROOT_KEY, KardexFilters, stockFiltersToQueryString(), UpdateCountLineInput, useCounts() (+24 more)

### Community 9 - "Production Runs API"
Cohesion: 0.10
Nodes (21): ACTOR, actualOutputQtySchema, batchesSchema, businessDateSchema, deleteProductionRunCommandSchema, indirectCostSchema, lineQtySchema, ListProductionRunsFilters (+13 more)
...
Cohesion: 0.06
Nodes (64): CreateItemDialog(), CreateItemDialogProps, ItemDetailDrawer(), ItemDetailDrawerProps, emptyItemFormValues(), ItemForm(), ItemFormParsed, ItemFormProps (+56 more)
...
Cohesion: 0.12
Nodes (22): sessionDetailKey(), SESSIONS_ROOT_KEY, useSession(), assertClosableDuration(), assertNoLiveLinkedEvents(), checkOpenSessionWarning(), SessionCostRow, SessionRow (+14 more)

### Community 15 - "Sessions Domain Service"
Cohesion: 0.05
Nodes (52): createItem(), PendingMovementChange, buildRecordExitMovement(), recordExit(), hasLaterDatedPurchaseForItem(), recordPurchase(), itemStock, productionConsumptions (+44 more)

### Community 16 - "Item Dialogs & Detail Drawer"
Cohesion: 0.29
Nodes (9): CollectPaymentDialog(), CollectPaymentDialogProps, computeMargin(), formatPercent(), SalesTable(), SalesTableProps, summarizeLines(), SaleDto (+1 more)
...
Cohesion: 0.12
Nodes (24): auditRoute, backupsRoute, costingRoute, dashboardRoute, errorHandler(), financeRoute, healthRoute, onboardingRoute (+16 more)
...
Cohesion: 0.13
Nodes (31): getCurrentWac(), snapshotUnitCost(), buildProductionMovementsFromConsumptions(), buildProductionRunCreateInputs(), buildProductionRunDeleteInputs(), buildProductionRunUpdateInputs(), commitProductionRunMutation(), computeProductionCosts() (+23 more)

### Community 21 - "Costing Routes & Replacement Cost"
Cohesion: 0.14
Nodes (18): RecipeEdge, topoOrderAffectedItems(), applyProductionCostCorrections(), buildNegativeSinceFixes(), comparePoints(), computeNegativeSince(), FrozenSnapshot, KardexPoint (+10 more)
...
Cohesion: 0.10
Nodes (38): applyReplacementCostRefresh(), DefaultRecipeInfo, planReplacementCostRefresh(), Statement, getStockConsistencyMismatches(), getStockValueTotal(), listStock(), buildDailySnapshotUpsert() (+30 more)

### Community 25 - "Production Run Table UI"
Cohesion: 0.09
Nodes (44): ProductionRunDetailDrawer(), ProductionRunDetailDrawerProps, emptyLine(), ProductionRunForm(), ProductionRunFormProps, ProductionRunFormState, productionRunToFormState(), formatBatches() (+36 more)

### Community 26 - "Session Detail & Form UI"
Cohesion: 0.22
Nodes (20): conflict(), buildDeleteExitReplayInput(), buildUpdateExitMovement(), deleteStockExit(), getStockExit(), listStockExits(), loadDeletedExit(), loadLiveExit() (+12 more)

### Community 27 - "Crypto Utils & CSRF"
Cohesion: 0.25
Nodes (11): timingSafeEqualString(), csrfTokensMatch(), generateCsrfToken(), unauthorized(), Bindings, CSRF_EXEMPT_PATHS, MUTATING_METHODS, requireCsrf() (+3 more)
...
Cohesion: 0.07
Nodes (31): fetchSession(), sessionQueryKey, SessionResult, useLogin(), assistantRoute, authenticatedRoute, financeRoute, inventoryRoute (+23 more)
...
Cohesion: 0.18
Nodes (16): datetimeLocalToIso(), emptyCostLine(), isoToDatetimeLocal(), parseDurationMinutes(), SessionCostLineValue, SessionForm(), SessionFormProps, SessionFormState (+8 more)
...
Cohesion: 0.09
Nodes (30): CalcTraceInput, LineEditor(), LineEditorLabels, LineEditorLine, LineEditorProps, formatBasisPointsAsPercent(), MarginBadge(), MarginBadgeProps (+22 more)

### Community 34 - "Event & Count Tables UI"
Cohesion: 0.08
Nodes (46): CalcTrace(), CalcTraceProps, EventTable(), EventTableColumn, EventTableProps, CountForm(), CountsTable(), varianceCount() (+38 more)

### Community 35 - "Finance API & Schemas"
Cohesion: 0.10
Nodes (27): AccountCard(), LiabilityReceivableStrip(), RecordTransactionDialog(), RecordTransactionDialogProps, TransferDialog(), TransferDialogProps, WithdrawDialog(), WithdrawDialogProps (+19 more)

### Community 36 - "Purchases API"
Cohesion: 0.08
Nodes (49): TransactionsTableProps, PurchaseDetailDrawer(), PurchaseDetailDrawerProps, emptyLine(), PurchaseForm(), PurchaseFormProps, PurchaseFormState, purchaseToFormState() (+41 more)
...
Cohesion: 0.09
Nodes (33): CountsTableProps, commitCount(), fetchLines(), findCountRowOrThrow(), getCount(), InventoryCountLineRow, InventoryCountRow, listCounts() (+25 more)
...
Cohesion: 0.32
Nodes (10): addMoney(), allocateLargestRemainder(), BasisPoints, Centavos, mulMoneyByBasisPoints(), mulMoneyByQty(), roundHalfUpToInt(), ADR-0011 (+2 more)

### Community 62 - "Security Audit Skill Phases"
Cohesion: 0.11
Nodes (31): fetchRecipeLines(), getRecipeSettingsDto(), ItemRow, loadItemsById(), RecipeLineRow, RecipeRow, toRecipeDto(), toRecipeLineDto() (+23 more)

### Community 63 - "Route Stubs & Nav Labels"
Cohesion: 0.24
Nodes (9): RouteStub(), navLabels, placeholderLabels, TODO: migrate into packages/shared/i18n/es.ts once that module exists (KOK-006+), AssistantRoute(), OrdersRoute(), PriceHealthRoute(), ReportsRoute() (+1 more)

### Community 64 - "Inventory Route Schemas"
Cohesion: 0.05
Nodes (46): getSession(), listSessions(), assistantInteractions, auditLog, customOrderLines, customOrders, dailySnapshots, financialAccounts (+38 more)
...
Cohesion: 0.09
Nodes (21): ACTOR, recipesRoute, estLaborMinSchema, expectedYieldQtySchema, GetRecipeResult, lineQtySchema, ListRecipesFilters, listRecipesFiltersSchema (+13 more)
...
Cohesion: 0.15
Nodes (21): stockMovements, authHeaders(), createExit(), CreateExitBody, createItem(), createPurchase(), CreatePurchaseBody, ExitDtoShape (+13 more)
...
Cohesion: 0.15
Nodes (16): buildCostingAdjustmentInsert(), CostingAdjustmentEntry, CostingAdjustmentTrigger, Statement, ADR-0016, detectWacDrift(), ADR-0016, WacDrift (+8 more)
...
Cohesion: 0.17
Nodes (17): applyWacEntry(), assertFiniteNonNegative(), assertSafeIntegerInput(), ReplayMovement, replayWacFrom(), replayWacWithTrace(), runReplay(), WAC_ENTRY_TYPES (+9 more)

### Community 76 - "Production Run Service Tests"
Cohesion: 0.08
Nodes (32): TransactionsTable(), ACCOUNTS_KEY, filtersToQueryString(), TRANSACTIONS_ROOT_KEY, transactionsListKey(), useAccounts(), useTransactions(), isInflow() (+24 more)

### Community 77 - "Production Run Route Tests"
Cohesion: 0.13
Nodes (16): ACTOR, sessionsRoute, sessionStatusSchema, sessionTypeSchema, businessDateSchema, costLineAmountSchema, deleteSessionCommandSchema, durationMinSchema (+8 more)
...
Cohesion: 0.10
Nodes (42): ACTOR, salesRoute, assertSaleNotCollected(), buildSaleCreateMovements(), buildSaleDeleteMutationInputs(), buildSaleOutMovementsFromLines(), buildSaleTransactionInputs(), buildSaleUpdateMutationInputs() (+34 more)

### Community 84 - "UUID Utils"
Cohesion: 0.26
Nodes (11): SaleDetailDrawer(), SaleDetailDrawerProps, RECEIVABLES_KEY, saleDetailKey(), SALES_ROOT_KEY, useCollectPayment(), useDeleteSale(), useInvalidateSales() (+3 more)
...
### Community 88 - "Purchases & Accounts Queries"
Cohesion: 0.22
Nodes (9): affectedIdsSchema, confirmFlagSchema, costDeltaSchema, ReplacementCostRefreshResultDto, REPLAY_CONFIRMATION_REQUIRED, ReplayConfirmationRequiredDetails, replayImpactSchema, emptyImpact (+1 more)

### Community 89 - "Client-Side Attack Classes"
Cohesion: 0.24
Nodes (8): recordProductionRun(), costingAdjustments, productionRuns, ACTOR, seedItem(), seedRecipe(), seedScenario(), TestDb
...
### Community 111 - "lucide-react Dependency"
Cohesion: 0.27
Nodes (10): SessionChip(), formatDuration(), SessionsTable(), filtersToQueryString(), sessionsListKey(), useSessions(), TODO: migrate into packages/shared/i18n/es.ts once that module exists (KOK-006+), sessionsLabels (+2 more)

### Community 113 - "@types/node Dependency"
Cohesion: 0.23
Nodes (10): ACCOUNTS_KEY, ITEMS_ROOT_KEY, ONBOARDING_ROOT_KEY, BulkCreateItemsCommand, bulkCreateItemsCommandSchema, OnboardingCompleteResult, OnboardingStatusResult, SetOpeningBalancesCommand (+2 more)

### Community 115 - "api/sessions.ts"
Cohesion: 0.26
Nodes (12): fromBase64Url(), timingSafeEqual(), toBase64Url(), deriveBits(), hashPassword(), ADR-0007, verifyPassword(), createSessionCookieValue() (+4 more)

### Community 139 - "sales/index.ts"
Cohesion: 0.16
Nodes (15): assertSafeIntegerInput(), assertValidMovementQty(), assertValidUnitCost(), buildItemStockUpsert(), buildMovementInsert(), buildStockMovementStatements(), MOVEMENT_DIRECTION, netDeltasByItem() (+7 more)

### Community 140 - "Client-Side and Browser Hunting Doc"
Cohesion: 0.18
Nodes (10): ACTOR, inventoryRoute, listCountsFiltersSchema, startCountCommandSchema, deleteStockExitCommandSchema, listStockExitsFiltersSchema, listWasteSummaryFiltersSchema, recordStockExitCommandSchema (+2 more)

### Community 141 - "validationError"
Cohesion: 0.36
Nodes (7): buildCostDto(), assertFiniteNonNegative(), assertSafeIntegerInput(), computeRecipeMargin(), computeTheoreticalCostPerOutputUnit(), RecipeCostLine, RecipeMargin

### Community 143 - "src/purchasing.ts"
Cohesion: 0.31
Nodes (7): filtersToQueryString(), salesListKey(), useReceivables(), useSales(), TODO: migrate into packages/shared/i18n/es.ts once that module exists (KOK-006+), salesLabels, SalesRoute()

### Community 144 - "rate-limit.ts"
Cohesion: 0.18
Nodes (8): authRoute, ADR-0007, DOMAIN_ERROR_CODES, DOMAIN_ERROR_HTTP_STATUS, DomainError, DomainErrorCode, DomainHttpStatus, rateLimited()

### Community 145 - "SaleForm.tsx"
Cohesion: 0.39
Nodes (7): emptyLine(), SaleForm(), SaleFormProps, SaleFormState, SaleLineValue, saleToFormState(), useUpdateSale()

### Community 146 - "api/production-runs.ts"
Cohesion: 0.50
Nodes (5): assertFiniteNonNegative(), assertSafeIntegerInput(), computeItemReplacementCost(), ReplacementCostLine, validationError()

### Community 148 - "api/finance.ts"
Cohesion: 0.33
Nodes (5): FINANCIAL_TRANSACTION_CATEGORIES, ITEM_KINDS, itemKindSchema, STOCK_MOVEMENT_TYPES, unitSchema
...
### Community 150 - "src/audit.ts"
Cohesion: 0.40
Nodes (4): AuditLogEntryDto, auditLogEntryDtoSchema, ListAuditLogResult, auditActorSchema

### Community 151 - "logging.ts"
Cohesion: 0.50
Nodes (4): SessionsTableProps, SessionHoursViewRow, SessionStatus, SessionListItemDto
...
## Knowledge Gaps
- **783 isolated node(s):** `SaleDetailDrawerProps`, `SaleFormProps`, `SaleLineValue`, `SaleFormState`, `SALES_ROOT_KEY` (+778 more)
...
- **Why does `nowIso()` connect `Costing Adjustments & Replay` to `Inventory Command Services`, `Auth Routes & Audit Log`, `Backups & Dashboard API`, `WAC Costing Engine`, `Financial Accounts & Transactions`, `sales/index.ts`, `Finance Dashboard Components`, `Transaction & Purchase Drawers UI`, `Sessions Domain Service`, `Count & Exit Forms UI`, `Production Movements & Kardex`, `Costing Routes & Replacement Cost`, `Production Run Table UI`, `Session Detail & Form UI`, `Sessions API & Schemas`, `Finance API & Schemas`, `Purchases API`, `Counts API & Schemas`, `Security Audit Skill Phases`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `createItem()` connect `Sessions Domain Service` to `Inventory Route Schemas`, `Auth Routes & Audit Log`, `Onboarding & Catalog API`, `Backups & Dashboard API`, `WAC Costing Engine`, `Query Client & Toast Provider`, `sales/index.ts`, `Costing Adjustments & Replay`, `Client-Side Attack Classes`, `Session Detail & Form UI`, `Security Audit Skill Phases`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `createDb()` connect `Backups & Dashboard API` to `Auth Routes & Audit Log`, `Onboarding & Catalog API`, `WAC Costing Engine`, `Financial Accounts & Transactions`, `Production Runs API`, `sales/index.ts`, `Client-Side and Browser Hunting Doc`, `Sessions Domain Service`, `rate-limit.ts`, `Count & Exit Forms UI`, `Costing Adjustments & Replay`, `Purchasing Route Tests`, `Security Audit Skill Phases`, `Inventory Route Schemas`, `Recipe Dependency Graph & Domain Errors`, `Exit/Purchase Route Tests`, `Query Client & Toast Provider`, `Production Run Route Tests`, `Client-Side Attack Classes`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `SaleDetailDrawerProps`, `SaleFormProps`, `SaleLineValue` to the rest of the system?**
  _783 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Backups & Dashboard API` be split into smaller, more focused modules?**
  _Cohesion score 0.08 - nodes in this community are weakly interconnected._
- **Should `WAC Costing Engine` be split into smaller, more focused modules?**
