...
## Corpus Check
- 404 files · ~335,366 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2492 nodes · 6491 edges · 147 communities (123 shown, 24 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 71 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ea13b87`
...
Cohesion: 0.05
Nodes (46): createItem(), recordExit(), hasLaterDatedPurchaseForItem(), recordPurchase(), itemStock, stockMovements, ACTOR, seedItem() (+38 more)

### Community 2 - "Auth Routes & Audit Log"
Cohesion: 0.14
Nodes (33): ACTOR, AuditEntry, buildAuditLogInsert(), addItemAlias(), removeItemAlias(), bulkCreateItems(), ItemRow, Statement (+25 more)
...
Cohesion: 0.23
Nodes (14): BACKUP_TABLES, dumpTable(), runBackup(), serializeSqlValue(), TableDump, deleteObject(), getObject(), listObjects() (+6 more)

### Community 5 - "WAC Costing Engine"
Cohesion: 0.14
Nodes (30): computePurchaseLineUnitCost(), buildPurchaseDeleteMutationInputs(), buildPurchaseInMovementsFromLines(), buildPurchaseTransactionInputs(), buildPurchaseUpdateMutationInputs(), commitPurchaseMutation(), compareKardexRows(), computeProjectedWac() (+22 more)

### Community 6 - "Stock Drift Repair & Counts API"
Cohesion: 0.08
Nodes (49): getCurrentWac(), snapshotUnitCost(), commitCount(), fetchLines(), findCountRowOrThrow(), getCount(), InventoryCountLineRow, InventoryCountRow (+41 more)

### Community 7 - "Financial Accounts & Transactions"
Cohesion: 0.09
Nodes (47): validationError(), assertSafeIntegerInput(), assertValidTransactionAmount(), BalanceMismatchDto, BalanceMismatchRow, buildAccountBalanceDelta(), buildReplaceTransactionsForSourceStatements(), buildTransactionInsert() (+39 more)

### Community 8 - "Finance & Count Dialogs UI"
Cohesion: 0.09
Nodes (36): LiabilityReceivableStrip(), RecordTransactionDialog(), TransferDialog(), WithdrawDialog(), CountFormProps, errorMessage(), ExitForm(), exitFormInitialState (+28 more)

### Community 9 - "Production Runs API"
Cohesion: 0.09
Nodes (23): affectedIdsSchema, confirmFlagSchema, costDeltaSchema, ReplacementCostRefreshResultDto, ReplayConfirmationRequiredDetails, replayImpactSchema, emptyImpact, ADR-0016 (+15 more)
...
Cohesion: 0.05
Nodes (39): ASSISTANT_CHANNELS, ASSISTANT_OUTCOMES, ASSISTANT_PIPELINES, AssistantChannel, assistantChannelSchema, AssistantOutcome, assistantOutcomeSchema, AssistantPipeline (+31 more)

### Community 12 - "Finance Dashboard Components"
Cohesion: 0.12
Nodes (16): ExitDetailDrawer(), ExitDetailDrawerProps, ShowToastOptions, ToastCard(), ToastContext, ToastContextValue, ToastItem, useDeleteStockExit() (+8 more)
...
Cohesion: 0.11
Nodes (28): LineEditorLabels, LineEditorLine, LineEditorProps, ProductionLineValue, PurchaseDetailDrawer(), emptyLine(), PurchaseForm(), PurchaseFormState (+20 more)

### Community 15 - "Sessions Domain Service"
Cohesion: 0.10
Nodes (31): planSessionCostAllocation(), assertClosableDuration(), assertCostLinesValid(), assertNoLiveLinkedEvents(), buildSessionCostTransactionInput(), buildSessionCostTransactionReplacementStatements(), checkOpenSessionWarning(), deleteSession() (+23 more)

### Community 16 - "Item Dialogs & Detail Drawer"
Cohesion: 0.12
Nodes (32): CreateItemDialog(), ItemDetailDrawer(), ItemDetailDrawerProps, emptyItemFormValues(), ItemForm(), parseItemFormValues(), ItemPicker(), MergeItemsDialog() (+24 more)

### Community 17 - "Item Form & Onboarding Steps"
Cohesion: 0.08
Nodes (43): CreateItemDialogProps, ItemFormParsed, ItemFormProps, ItemFormValues, itemFormValuesFromDto(), UNIT_ABBREV, ItemPickerProps, CountDetailView() (+35 more)

### Community 18 - "Count & Exit Forms UI"
Cohesion: 0.10
Nodes (27): BackupRunDetail, backupsRoute, ADR-0015, catalogRoute, costingRoute, dashboardRoute, errorHandler(), healthRoute (+19 more)
...
Cohesion: 0.11
Nodes (35): buildProductionMovementsFromConsumptions(), buildProductionRunCreateInputs(), buildProductionRunDeleteInputs(), buildProductionRunUpdateInputs(), commitProductionRunMutation(), compareKardexRows(), computeProductionCosts(), computeProjectedItemWacAcrossRuns() (+27 more)

### Community 21 - "Costing Routes & Replacement Cost"
Cohesion: 0.14
Nodes (24): buildCostingAdjustmentInsert(), CostingAdjustmentTrigger, Statement, ADR-0016, applyProductionCostCorrections(), buildNegativeSinceFixes(), comparePoints(), computeNegativeSince() (+16 more)
...
Cohesion: 0.17
Nodes (12): buildJobRunInsert(), JOB_REGISTRY, JobHandler, runNotImplementedJob(), runReplacementCostRefresh(), Statement, ACTOR, seedDefaultRecipe() (+4 more)

### Community 25 - "Production Run Table UI"
Cohesion: 0.11
Nodes (35): ProductionRunDetailDrawer(), ProductionRunDetailDrawerProps, emptyLine(), ProductionRunForm(), ProductionRunFormProps, ProductionRunFormState, productionRunToFormState(), formatBatches() (+27 more)
...
Cohesion: 0.06
Nodes (62): SessionChip(), SessionDetailDrawer(), datetimeLocalToIso(), emptyCostLine(), isoToDatetimeLocal(), parseDurationMinutes(), SessionCostLineValue, SessionForm() (+54 more)
...
Cohesion: 0.11
Nodes (28): CalcTrace(), CalcTraceInput, CalcTraceProps, LineEditor(), formatBasisPointsAsPercent(), MarginBadge(), MarginBadgeProps, MarginTone (+20 more)

### Community 34 - "Event & Count Tables UI"
Cohesion: 0.13
Nodes (32): EventTable(), EventTableColumn, EventTableProps, AccountCard(), TransactionsTable(), TransactionsTableProps, CountsTable(), varianceCount() (+24 more)
...
Cohesion: 0.11
Nodes (18): ACTOR, CONTENT_TYPE_EXTENSIONS, purchasingRoute, businessDateSchema, DeletePurchaseCommand, deletePurchaseCommandSchema, lineTotalSchema, listPurchasesFiltersSchema (+10 more)
...
Cohesion: 0.08
Nodes (37): ExitFormProps, countsFiltersToQueryString(), exitsFiltersToQueryString(), INVENTORY_ROOT_KEY, KardexFilters, kardexFiltersToQueryString(), stockFiltersToQueryString(), UpdateCountLineInput (+29 more)
...
Cohesion: 0.11
Nodes (18): CountsTableProps, businessDateSchema, CommitCountCommand, CommitCountResult, CountAdjustmentDto, countedQtySchema, InventoryCountDto, InventoryCountLineDto (+10 more)
...
Cohesion: 0.19
Nodes (17): CostingAdjustmentEntry, buildCostDto(), assertFiniteNonNegative(), assertSafeIntegerInput(), computeRecipeMargin(), computeTheoreticalCostPerOutputUnit(), RecipeCostLine, RecipeMargin (+9 more)

### Community 62 - "Security Audit Skill Phases"
Cohesion: 0.19
Nodes (23): fetchRecipeLines(), getRecipeSettingsDto(), ItemRow, loadItemsById(), RecipeLineRow, RecipeRow, toRecipeDto(), toRecipeLineDto() (+15 more)
...
Cohesion: 0.22
Nodes (11): RecipeEdge, topoOrderAffectedItems(), assertFiniteNonNegative(), assertSafeIntegerInput(), computeItemReplacementCost(), applyReplacementCostRefresh(), DefaultRecipeInfo, planReplacementCostRefresh() (+3 more)

### Community 68 - "Recipe Dependency Graph & Domain Errors"
Cohesion: 0.20
Nodes (15): applyWacEntry(), assertFiniteNonNegative(), assertSafeIntegerInput(), recomputeWacFromMovements(), ReplayMovement, replayWacFrom(), replayWacWithTrace(), runReplay() (+7 more)
...
Cohesion: 0.18
Nodes (14): detectWacDrift(), ADR-0016, WacDrift, getBalanceConsistencyMismatches(), listAccounts(), getStockConsistencyMismatches(), getStockValueTotal(), buildDailySnapshotUpsert() (+6 more)
...
Cohesion: 0.06
Nodes (40): isLoginRateLimited(), recordFailedLoginAttempt(), PendingMovementChange, getSetting(), setSetting(), appSettings, assistantInteractions, auditLog (+32 more)
...
Cohesion: 0.17
Nodes (14): filtersToQueryString(), purchaseDetailKey(), PURCHASES_ROOT_KEY, purchasesListKey(), readCsrfCookie(), uploadPurchasePhoto(), UploadPurchasePhotoResult, usePurchase() (+6 more)

### Community 84 - "UUID Utils"
Cohesion: 0.18
Nodes (11): DailySnapshotValues, getLatestJobRun(), JobRunValues, Statement, dailySnapshots, jobRuns, ACTOR, seedDriftedItem() (+3 more)
...
Cohesion: 0.17
Nodes (13): RecordTransactionDialogProps, TransferDialogProps, WithdrawDialogProps, PurchaseDetailDrawerProps, PurchaseFormProps, PurchasesTableProps, SessionDetailDrawerProps, FinancialAccountType (+5 more)

### Community 89 - "Client-Side Attack Classes"
Cohesion: 0.12
Nodes (22): StockTableProps, ReplayRow, KardexViewRow, listKardex(), listStock(), StockMismatchDto, StockMismatchRow, toKardexRowDto() (+14 more)
...
Cohesion: 0.20
Nodes (6): getPurchase(), listPurchases(), ACTOR, seedItem(), TestDb, ADR-0016
...
## Knowledge Gaps
- **755 isolated node(s):** `1. Scope: CREATE + READ only`, `2. Why `recordSale` never calls `planCostingReplay``, `3. Cost/cash shape, in one paragraph`, `4. Fields intentionally left unwired`, `5. Where things live` (+750 more)
...
- **Why does `nowIso()` connect `Sessions Domain Service` to `Inventory Command Services`, `Auth Routes & Audit Log`, `Backups & Dashboard API`, `WAC Costing Engine`, `Stock Drift Repair & Counts API`, `Financial Accounts & Transactions`, `Finance & Count Dialogs UI`, `Transaction & Purchase Drawers UI`, `Item Form & Onboarding Steps`, `Count & Exit Forms UI`, `Production Movements & Kardex`, `Costing Routes & Replacement Cost`, `Costing Adjustments & Replay`, `Production Run Table UI`, `Sessions API & Schemas`, `Event & Count Tables UI`, `Security Audit Skill Phases`, `Replay Confirmation Hook`, `Purchasing API & Schemas`, `lucide-react Dependency`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Db` connect `Costing Routes & Replacement Cost` to `Inventory Command Services`, `Auth Routes & Audit Log`, `Replay Confirmation Hook`, `Backups & Dashboard API`, `WAC Costing Engine`, `Stock Drift Repair & Counts API`, `Financial Accounts & Transactions`, `Waste & Stock Exits Schemas`, `Purchasing API & Schemas`, `Sessions Domain Service`, `Sessions Route Tests`, `UUID Utils`, `Production Movements & Kardex`, `Costing Adjustments & Replay`, `Client-Side Attack Classes`, `Security Audit Skill Phases`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `cn()` connect `Event & Count Tables UI` to `CalcTrace & Stock Table UI`, `Dashboard Stat Widgets`, `App Shell & Navigation`, `Finance & Count Dialogs UI`, `Finance Dashboard Components`, `Transaction & Purchase Drawers UI`, `Item Dialogs & Detail Drawer`, `Item Form & Onboarding Steps`, `Backup Card UI`?**
