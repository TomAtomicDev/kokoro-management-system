...
## Summary
- 2493 nodes · 6586 edges · 151 communities (127 shown, 24 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 71 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `749174dc`
...
6. `formatMoney()` - 56 edges
7. `notFound()` - 54 edges
8. `buildAuditLogInsert()` - 52 edges
9. `cn()` - 50 edges
...
Cohesion: 0.12
Nodes (27): CountDetailView(), StepBalances(), StepBalancesProps, FIXTURE_ITEMS, fixtureToRow(), StepCatalog(), StepCatalogProps, StepCount() (+19 more)

### Community 1 - "Inventory Command Services"
Cohesion: 0.06
Nodes (40): createItem(), getStockExit(), listStockExits(), recordExit(), hasLaterDatedPurchaseForItem(), recordPurchase(), financialAccounts, itemStock (+32 more)

### Community 2 - "Auth Routes & Audit Log"
Cohesion: 0.18
Nodes (30): ACTOR, AuditEntry, buildAuditLogInsert(), addItemAlias(), removeItemAlias(), bulkCreateItems(), ItemRow, Statement (+22 more)
...
Cohesion: 0.11
Nodes (37): commitCount(), fetchLines(), findCountRowOrThrow(), getCount(), InventoryCountLineRow, InventoryCountRow, listCounts(), startCount() (+29 more)

### Community 7 - "Financial Accounts & Transactions"
Cohesion: 0.10
Nodes (38): assertSafeIntegerInput(), assertValidTransactionAmount(), BalanceMismatchDto, BalanceMismatchRow, buildAccountBalanceDelta(), buildReplaceTransactionsForSourceStatements(), buildTransactionInsert(), FinancialAccountRow (+30 more)

### Community 8 - "Finance & Count Dialogs UI"
Cohesion: 0.19
Nodes (14): AccountCard(), LiabilityReceivableStrip(), RecordTransactionDialog(), TransferDialog(), WithdrawDialog(), Select(), SelectProps, useInvalidateFinance() (+6 more)
...
Cohesion: 0.06
Nodes (38): ASSISTANT_CHANNELS, ASSISTANT_OUTCOMES, ASSISTANT_PIPELINES, AssistantChannel, assistantChannelSchema, AssistantOutcome, assistantOutcomeSchema, AssistantPipeline (+30 more)

### Community 12 - "Finance Dashboard Components"
Cohesion: 0.08
Nodes (27): assistantInteractions, auditLog, customOrderLines, customOrders, dailySnapshots, idempotencyKeys, inventoryCountLines, pendingDrafts (+19 more)
...
Cohesion: 0.27
Nodes (8): PurchaseFormProps, PurchasesTable(), PurchasesTableProps, summarizeLines(), purchasesLabels, TODO: migrate into packages/shared/i18n/es.ts once that module exists (KOK-006+), PurchaseDto, PurchaseLineDto
...
Cohesion: 0.12
Nodes (32): CreateItemDialog(), CreateItemDialogProps, ItemDetailDrawer(), ItemDetailDrawerProps, emptyItemFormValues(), ItemForm(), ItemFormProps, itemFormValuesFromDto() (+24 more)

### Community 17 - "Item Form & Onboarding Steps"
Cohesion: 0.11
Nodes (31): ItemFormParsed, ItemFormValues, CountDetailViewProps, StockTableProps, LineEditorProps, CatalogRow, FixtureItem, StepCountProps (+23 more)

### Community 18 - "Count & Exit Forms UI"
Cohesion: 0.09
Nodes (32): authRoute, catalogRoute, costingRoute, dashboardRoute, errorHandler(), ACTOR, financeRoute, healthRoute (+24 more)
...
Cohesion: 0.09
Nodes (38): ACTOR, productionRunsRoute, buildProductionRunDeleteInputs(), commitProductionRunMutation(), compareKardexRows(), computeProjectedItemWacAcrossRuns(), computeProjectedOutputWac(), deleteProductionRun() (+30 more)

### Community 21 - "Costing Routes & Replacement Cost"
Cohesion: 0.09
Nodes (29): ImpactConfirmDialogProps, PendingReplayConfirmation, ReplayConfirmationRequiredDetails, buildCostingAdjustmentInsert(), CostingAdjustmentEntry, CostingAdjustmentTrigger, Statement, ADR-0016 (+21 more)
...
Cohesion: 0.16
Nodes (13): BackupRunDetail, backupsRoute, ADR-0015, buildJobRunInsert(), DailySnapshotValues, getLatestJobRun(), JobRunValues, Statement (+5 more)

### Community 25 - "Production Run Table UI"
Cohesion: 0.09
Nodes (37): DetailDrawer(), DetailDrawerProps, LineEditor(), LineEditorLabels, LineEditorLine, ProductionRunDetailDrawer(), ProductionRunDetailDrawerProps, emptyLine() (+29 more)

### Community 26 - "Session Detail & Form UI"
Cohesion: 0.23
Nodes (17): RecipeDetailDrawer(), RecipesTable(), SaleDetailDrawer(), emptyLine(), SaleForm(), computeMargin(), formatPercent(), SalesTable() (+9 more)
...
Cohesion: 0.14
Nodes (20): CalcTrace(), CalcTraceInput, CalcTraceProps, formatBasisPointsAsPercent(), MarginBadge(), MarginBadgeProps, MarginTone, TONE_CLASSES (+12 more)

### Community 34 - "Event & Count Tables UI"
Cohesion: 0.10
Nodes (31): EventTable(), EventTableColumn, EventTableProps, TransactionsTable(), CountsTable(), varianceCount(), formatUnitCost(), KardexView() (+23 more)

### Community 35 - "Finance API & Schemas"
Cohesion: 0.11
Nodes (22): ACCOUNTS_KEY, TRANSACTIONS_ROOT_KEY, FinancialAccountType, financialTransactionCategorySchema, amountSchema, businessDateSchema, descriptionSchema, ListAccountsResult (+14 more)
...
Cohesion: 0.22
Nodes (11): LowStockStrip(), QuickAddShortcuts(), SHORTCUTS, useQuickAdd(), useDashboardSummary(), useOnboardingStatus(), api, dashboardLabels (+3 more)
...
Cohesion: 0.09
Nodes (29): CountsTableProps, countsFiltersToQueryString(), exitsFiltersToQueryString(), INVENTORY_ROOT_KEY, KardexFilters, kardexFiltersToQueryString(), stockFiltersToQueryString(), UpdateCountLineInput (+21 more)
...
Cohesion: 0.47
Nodes (7): allocateLargestRemainder(), BasisPoints, mulMoneyByBasisPoints(), mulMoneyByQty(), roundHalfUpToInt(), ADR-0011, assertSafeInteger()

### Community 62 - "Security Audit Skill Phases"
Cohesion: 0.05
Nodes (63): filtersToQueryString(), recipeDetailKey(), RECIPES_ROOT_KEY, recipesListKey(), useRecipeQuery(), buildCostDto(), fetchRecipeLines(), getRecipeSettingsDto() (+55 more)

### Community 63 - "Route Stubs & Nav Labels"
Cohesion: 0.27
Nodes (8): RouteStub(), navLabels, placeholderLabels, TODO: migrate into packages/shared/i18n/es.ts once that module exists (KOK-006+), AssistantRoute(), OrdersRoute(), PriceHealthRoute(), SettingsAiRoute()
...
Cohesion: 0.11
Nodes (23): RecipeEdge, topoOrderAffectedItems(), ADR-0016, WacDrift, assertFiniteNonNegative(), assertSafeIntegerInput(), computeItemReplacementCost(), applyReplacementCostRefresh() (+15 more)

### Community 68 - "Recipe Dependency Graph & Domain Errors"
Cohesion: 0.21
Nodes (12): filtersToQueryString(), saleDetailKey(), SALES_ROOT_KEY, salesListKey(), useInvalidateSales(), useRecordSale(), useSale(), useSales() (+4 more)
...
Cohesion: 0.22
Nodes (6): DOMAIN_ERROR_CODES, DOMAIN_ERROR_HTTP_STATUS, DomainError, DomainErrorCode, DomainHttpStatus, rateLimited()
...
Cohesion: 0.22
Nodes (13): detectWacDrift(), getBalanceConsistencyMismatches(), listAccounts(), getStockConsistencyMismatches(), getStockValueTotal(), listStock(), toStockRowDto(), buildDailySnapshotUpsert() (+5 more)

### Community 76 - "Production Run Service Tests"
Cohesion: 0.13
Nodes (17): SalesTableProps, PaymentMethod, paymentMethodSchema, PaymentStatus, SaleChannel, businessDateSchema, listSalesFiltersSchema, occurredAtSchema (+9 more)
...
Cohesion: 0.33
Nodes (6): ADR-0007, isLoginRateLimited(), recordFailedLoginAttempt(), createDb(), getCookieValue(), login()
...
Cohesion: 0.20
Nodes (17): PurchaseDetailDrawer(), filtersToQueryString(), purchaseDetailKey(), PURCHASES_ROOT_KEY, purchasesListKey(), readCsrfCookie(), uploadPurchasePhoto(), UploadPurchasePhotoResult (+9 more)

### Community 84 - "UUID Utils"
Cohesion: 0.10
Nodes (27): ExitFormProps, ExitsTableProps, buildDeleteExitReplayInput(), Statement, StockExitRow, ADR-0016, listWasteSummary(), WasteViewRow (+19 more)
...
Cohesion: 0.17
Nodes (12): RecordTransactionDialogProps, TransactionsTableProps, TransferDialogProps, WithdrawDialogProps, PurchaseDetailDrawerProps, SaleDetailDrawerProps, SaleFormProps, SessionDetailDrawerProps (+4 more)

### Community 89 - "Client-Side Attack Classes"
Cohesion: 0.33
Nodes (6): filtersToQueryString(), transactionsListKey(), useAccounts(), useTransactions(), FinanceRoute(), SalesRoute()
...
Cohesion: 0.18
Nodes (14): FinancialAccountRow, getSale(), listSales(), recordSale(), SaleLineRow, SaleRow, Statement, toSaleDto() (+6 more)
...
Cohesion: 0.23
Nodes (19): getCurrentWac(), applyWacEntry(), assertFiniteNonNegative(), assertSafeIntegerInput(), runReplay(), snapshotUnitCost(), WAC_ENTRY_TYPES, validationError() (+11 more)
...
Cohesion: 0.08
Nodes (33): ItemPicker(), CountForm(), CountFormProps, ExitDetailDrawer(), ExitDetailDrawerProps, errorMessage(), ExitForm(), exitFormInitialState (+25 more)
...
## Knowledge Gaps
- **751 isolated node(s):** `fs`, `path`, `schemaPath`, `hono-docs`, `$schema` (+746 more)
...
- **Why does `nowIso()` connect `Stock Drift Repair & Counts API` to `Recipes API & Queries`, `Inventory Command Services`, `Auth Routes & Audit Log`, `Backups & Dashboard API`, `WAC Costing Engine`, `Financial Accounts & Transactions`, `Finance & Count Dialogs UI`, `sales/index.ts`, `theoretical-cost.ts`, `validationError`, `Sessions Domain Service`, `Count & Exit Forms UI`, `Production Movements & Kardex`, `useReplayConfirmableMutation.ts`, `PurchaseForm`, `Costing Routes & Replacement Cost`, `Costing Adjustments & Replay`, `Production Run Table UI`, `Session Detail & Form UI`, `Sessions API & Schemas`, `Security Audit Skill Phases`, `Replay Confirmation Hook`, `Purchasing API & Schemas`, `UUID Utils`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Db` connect `Auth Routes & Audit Log` to `Inventory Command Services`, `Replay Confirmation Hook`, `Backups & Dashboard API`, `WAC Costing Engine`, `Stock Drift Repair & Counts API`, `Financial Accounts & Transactions`, `Purchasing API & Schemas`, `sales/index.ts`, `Sessions Domain Service`, `Sessions Route Tests`, `Item Form & Onboarding Steps`, `UUID Utils`, `Costing Routes & Replacement Cost`, `Production Movements & Kardex`, `Costing Adjustments & Replay`, `Security Audit Skill Phases`, `Sessions API & Schemas`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `validationError()` connect `validationError` to `Auth Routes & Audit Log`, `Replay Confirmation Hook`, `WAC Costing Engine`, `Stock Drift Repair & Counts API`, `Financial Accounts & Transactions`, `Query Client & Toast Provider`, `sales/index.ts`, `Sessions Domain Service`, `Item Form & Onboarding Steps`, `UUID Utils`, `Costing Routes & Replacement Cost`, `Production Movements & Kardex`, `Costing Adjustments & Replay`, `Security Audit Skill Phases`, `Sessions API & Schemas`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
