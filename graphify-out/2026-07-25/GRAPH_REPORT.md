...
## Corpus Check
- 423 files · ~357,552 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2615 nodes · 7058 edges · 148 communities (123 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.78)
...
4. `generateUuidV7()` - 65 edges
5. `validationError()` - 63 edges
6. `notFound()` - 61 edges
7. `formatMoney()` - 58 edges
8. `buildAuditLogInsert()` - 57 edges
9. `createDb()` - 52 edges
10. `cn()` - 50 edges
...
Cohesion: 0.09
Nodes (33): ItemPicker(), ItemPickerProps, CalcTrace(), CalcTraceInput, CalcTraceProps, LineEditor(), LineEditorLabels, LineEditorLine (+25 more)

### Community 1 - "Inventory Command Services"
Cohesion: 0.09
Nodes (16): costingAdjustments, financialAccounts, ACTOR, seedItem(), seedPurchase(), TestDb, ADR-0016, getCookieValue() (+8 more)

### Community 2 - "Auth Routes & Audit Log"
Cohesion: 0.10
Nodes (40): ACTOR, addItemAlias(), removeItemAlias(), fetchAliasesForItem(), fetchAliasesForItems(), ItemAliasRow, ItemRow, toAliasDto() (+32 more)

### Community 3 - "Onboarding & Catalog API"
Cohesion: 0.21
Nodes (11): ExitDetailDrawer(), ExitDetailDrawerProps, ShowToastOptions, ToastCard(), ToastContext, ToastContextValue, ToastItem, useToast() (+3 more)
...
Cohesion: 0.09
Nodes (37): CostingReplayPlan, buildPurchaseDeleteMutationInputs(), buildPurchaseInMovementsFromLines(), buildPurchaseTransactionInputs(), buildPurchaseUpdateMutationInputs(), commitPurchaseMutation(), compareKardexRows(), computeProjectedWac() (+29 more)

### Community 6 - "Stock Drift Repair & Counts API"
Cohesion: 0.13
Nodes (28): CollectPaymentDialog(), CollectPaymentDialogProps, SaleDetailDrawer(), SaleDetailDrawerProps, emptyLine(), SaleForm(), SaleFormProps, SaleFormState (+20 more)

### Community 7 - "Financial Accounts & Transactions"
Cohesion: 0.09
Nodes (47): buildAuditLogInsert(), bulkCreateItems(), assertSafeIntegerInput(), assertValidTransactionAmount(), BalanceMismatchDto, BalanceMismatchRow, buildAccountBalanceDelta(), buildReplaceTransactionsForSourceStatements() (+39 more)

### Community 8 - "Finance & Count Dialogs UI"
Cohesion: 0.10
Nodes (29): ExitFormProps, ExitsTableProps, INVENTORY_ROOT_KEY, KardexFilters, kardexFiltersToQueryString(), UpdateCountLineInput, useKardex(), useWasteSummary() (+21 more)

### Community 9 - "Production Runs API"
Cohesion: 0.11
Nodes (15): createItem(), stockMovements, ACTOR, seedItem(), seedMovement(), TestDb, ADR-0016, ACTOR (+7 more)
...
Cohesion: 0.10
Nodes (33): CreateItemDialog(), CreateItemDialogProps, emptyItemFormValues(), ItemForm(), ItemFormParsed, ItemFormProps, ItemFormValues, parseItemFormValues() (+25 more)
...
Cohesion: 0.22
Nodes (7): ACTOR, CONTENT_TYPE_EXTENSIONS, purchasingRoute, deletePurchaseCommandSchema, listPurchasesFiltersSchema, purchaseImpactRequestSchema, updatePurchaseCommandSchema
...
Cohesion: 0.13
Nodes (23): ItemDetailDrawer(), ItemDetailDrawerProps, itemFormValuesFromDto(), MergeItemsDialog(), DetailDrawer(), DetailDrawerProps, editCountLabel(), useAuditLog() (+15 more)

### Community 17 - "Item Form & Onboarding Steps"
Cohesion: 0.25
Nodes (7): businessDateSchema, ListKardexFilters, listKardexFiltersSchema, ListKardexResult, ListStockFilters, listStockFiltersSchema, ListStockResult

### Community 18 - "Count & Exit Forms UI"
Cohesion: 0.08
Nodes (34): auditRoute, BackupRunDetail, backupsRoute, ADR-0015, catalogRoute, costingRoute, dashboardRoute, errorHandler() (+26 more)
...
Cohesion: 0.06
Nodes (60): ProductionRunFormProps, ACTOR, buildProductionMovementsFromConsumptions(), buildProductionRunCreateInputs(), buildProductionRunDeleteInputs(), buildProductionRunUpdateInputs(), commitProductionRunMutation(), compareKardexRows() (+52 more)

### Community 21 - "Costing Routes & Replacement Cost"
Cohesion: 0.12
Nodes (12): listSessions(), auditLog, sessions, authHeaders(), createSession(), CreateSessionBody, getCookieValue(), login() (+4 more)
...
Cohesion: 0.12
Nodes (35): applyReplacementCostRefresh(), planReplacementCostRefresh(), buildDailySnapshotUpsert(), buildJobRunInsert(), DailySnapshotValues, getLatestJobRun(), JobRunValues, Statement (+27 more)

### Community 25 - "Production Run Table UI"
Cohesion: 0.08
Nodes (46): MergeItemsDialogProps, AccountCard(), LiabilityReceivableStrip(), RecordTransactionDialog(), TransferDialog(), WithdrawDialog(), CountDetailView(), CountForm() (+38 more)

### Community 26 - "Session Detail & Form UI"
Cohesion: 0.12
Nodes (36): getCurrentWac(), conflict(), notFound(), commitCount(), findCountRowOrThrow(), updateCountLine(), buildDeleteExitReplayInput(), buildRecordExitMovement() (+28 more)

### Community 27 - "Crypto Utils & CSRF"
Cohesion: 0.07
Nodes (46): buildCostingAdjustmentInsert(), CostingAdjustmentEntry, CostingAdjustmentTrigger, Statement, ADR-0016, RecipeEdge, topoOrderAffectedItems(), ADR-0016 (+38 more)
...
Cohesion: 0.07
Nodes (27): fetchSession(), assistantRoute, authenticatedRoute, financeRoute, inventoryRoute, loginRoute, onboardingRoute, ordersRoute (+19 more)
...
Cohesion: 0.08
Nodes (47): ProductionRunDetailDrawer(), ProductionRunDetailDrawerProps, emptyLine(), ProductionRunForm(), ProductionRunFormState, productionRunToFormState(), formatBatches(), formatYieldPct() (+39 more)

### Community 34 - "Event & Count Tables UI"
Cohesion: 0.11
Nodes (36): EventTable(), EventTableColumn, EventTableProps, TransactionsTable(), CountsTable(), varianceCount(), ExitsTable(), formatUnitCost() (+28 more)

### Community 35 - "Finance API & Schemas"
Cohesion: 0.25
Nodes (8): countsFiltersToQueryString(), exitsFiltersToQueryString(), stockFiltersToQueryString(), useCounts(), useRefreshReplacementCosts(), useStock(), useStockExits(), InventoryRoute()

### Community 36 - "Purchases API"
Cohesion: 0.08
Nodes (49): RecordTransactionDialogProps, TransactionsTableProps, TransferDialogProps, WithdrawDialogProps, PurchaseDetailDrawer(), PurchaseDetailDrawerProps, emptyLine(), PurchaseForm() (+41 more)
...
Cohesion: 0.14
Nodes (20): CountsTableProps, InventoryCountLineRow, InventoryCountRow, Statement, businessDateSchema, CommitCountCommand, commitCountCommandSchema, CommitCountResult (+12 more)
...
Cohesion: 0.05
Nodes (65): RecipeFormProps, filtersToQueryString(), recipeDetailKey(), RECIPES_ROOT_KEY, recipesListKey(), useRecipeQuery(), ACTOR, recipesRoute (+57 more)
...
Cohesion: 0.10
Nodes (22): assistantInteractions, customOrderLines, customOrders, dailySnapshots, idempotencyKeys, inventoryCountLines, items, itemStock (+14 more)
...
Cohesion: 0.11
Nodes (24): detectWacDrift(), ReplayRow, getBalanceConsistencyMismatches(), listAccounts(), getStockConsistencyMismatches(), getStockValueTotal(), KardexViewRow, listKardex() (+16 more)
...
Cohesion: 0.18
Nodes (12): isLoginRateLimited(), recordFailedLoginAttempt(), AuditEntry, listAuditLogForEntity(), ItemRow, Statement, PendingMovementChange, StockMovementInput (+4 more)
...
Cohesion: 0.12
Nodes (16): ACTOR, inventoryRoute, fetchLines(), getCount(), listCounts(), toCountDto(), toLineDto(), listCountsFiltersSchema (+8 more)
...
Cohesion: 0.16
Nodes (20): assertFiniteNonNegative(), assertSafeIntegerInput(), computeItemReplacementCost(), ReplacementCostLine, DOMAIN_ERROR_CODES, DOMAIN_ERROR_HTTP_STATUS, DomainErrorCode, DomainHttpStatus (+12 more)
...
Cohesion: 0.11
Nodes (36): ACTOR, assertSaleNotCollected(), buildSaleDeleteMutationInputs(), buildSaleOutMovementsFromLines(), buildSaleTransactionInputs(), buildSaleUpdateMutationInputs(), commitSaleMutation(), deleteSale() (+28 more)
...
Cohesion: 0.18
Nodes (10): inventoryCounts, purchases, getCookieValue(), login(), ACTOR, ItemCategory, ItemKind, seedItem() (+2 more)
...
Cohesion: 0.18
Nodes (14): ACCOUNTS_KEY, ITEMS_ROOT_KEY, ONBOARDING_ROOT_KEY, useCompleteOnboarding(), ACTOR, onboardingRoute, BulkCreateItemsCommand, bulkCreateItemsCommandSchema (+6 more)
...
Cohesion: 0.07
Nodes (37): filtersToQueryString(), RECEIVABLES_KEY, saleDetailKey(), SALES_ROOT_KEY, salesListKey(), useReceivables(), useSale(), useSales() (+29 more)
...
## Knowledge Gaps
- **764 isolated node(s):** `fs`, `path`, `schemaPath`, `hono-docs`, `$schema` (+759 more)
...
- **Why does `nowIso()` connect `Costing Adjustments & Replay` to `Auth Routes & Audit Log`, `Backups & Dashboard API`, `WAC Costing Engine`, `Stock Drift Repair & Counts API`, `Financial Accounts & Transactions`, `Production Runs API`, `Count & Exit Forms UI`, `Production Movements & Kardex`, `Production Run Table UI`, `Session Detail & Form UI`, `Crypto Utils & CSRF`, `Sessions API & Schemas`, `CalcTrace & Stock Table UI`, `Event & Count Tables UI`, `Purchases API`, `Counts API & Schemas`, `Security Audit Skill Phases`, `Replay Confirmation Hook`, `Recipe Dependency Graph & Domain Errors`, `Query Client & Toast Provider`, `movements.ts`, `Finance API Route`, `api/onboarding.ts`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `validationError()` connect `movements.ts` to `Auth Routes & Audit Log`, `Recipe Dependency Graph & Domain Errors`, `WAC Costing Engine`, `Financial Accounts & Transactions`, `Count & Exit Forms UI`, `Finance API Route`, `Production Movements & Kardex`, `Counts API & Schemas`, `Costing Adjustments & Replay`, `Session Detail & Form UI`, `Crypto Utils & CSRF`, `Security Audit Skill Phases`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Db` connect `Costing Adjustments & Replay` to `Auth Routes & Audit Log`, `Replay Confirmation Hook`, `Recipe Dependency Graph & Domain Errors`, `WAC Costing Engine`, `Backups & Dashboard API`, `Financial Accounts & Transactions`, `Finance & Count Dialogs UI`, `Query Client & Toast Provider`, `Production Runs API`, `movements.ts`, `Finance API Route`, `Production Movements & Kardex`, `Counts API & Schemas`, `Session Detail & Form UI`, `Crypto Utils & CSRF`, `Security Audit Skill Phases`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
