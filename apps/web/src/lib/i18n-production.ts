...
export const productionLabels = {
  ...
  fieldRecipe: "Receta (opcional)",
  recipePlaceholder: "Selecciona una receta",
  recipeLessOption: "Sin receta",
  fieldOutputItem: "Ítem de salida",
  outputItemPlaceholder: "Selecciona el ítem que se produjo",
  fieldBatches: "Tandas",
  fieldDate: "Fecha",
  ...
  errors: {
    ...
    outputItemRequired: "Selecciona el ítem de salida cuando la producción no tiene receta.",
  ...
  impactCreateDescription:
    "Registrar esta producción puede redistribuir el costo compartido entre otras producciones de la sesión o recalcular costos ya registrados. Revisa el impacto y confirma para guardarla.",
