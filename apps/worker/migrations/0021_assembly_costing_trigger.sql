...
CREATE TABLE `__new_costing_adjustments` (
	...
	CONSTRAINT "costing_adjustments_trigger_event_type_check" CHECK("__new_costing_adjustments"."trigger_event_type" IN ('purchase','production_run','stock_exit','session','sale','assembly'))
);
