...
CREATE TABLE `__new_items` (
	...
	CONSTRAINT "items_category_check" CHECK("__new_items"."category" IN ('INGREDIENT','PACKAGING','LABEL','BAKERY','DAIRY','PASTRY','OTHER')),
...
SELECT "id", "name", "kind", "category", "unit", "wac_mc", "replacement_cost_mc", "replacement_cost_updated_at", "sale_price_mc", "min_stock_qty", "is_active", "notes", "created_at", "updated_at" FROM `items`;
--> statement-breakpoint
